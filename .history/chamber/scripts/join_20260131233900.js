...
const buttons = document.querySelectorAll("buttons[data-level]");
...
const npo= document.getElementById('npo');
const npoBenefits= document.getElementById('npo-benefits');
const closeNpo= document.getElementById('close-npo');

npo.addEventListener("click", () => {
    npoBenefits.showModal();
});

closeNpo.addEventListener("click", () => {
    npoBenefits.close();
});
